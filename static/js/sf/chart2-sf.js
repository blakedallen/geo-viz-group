...
var update_sealevel = function(data, cb2){
...
document.getElementById("chart2years")
  .addEventListener("input", function(e){
    ...
    update_sealevel({"gt":totalCOO2,"years":e.target.value}, cb2);
});
